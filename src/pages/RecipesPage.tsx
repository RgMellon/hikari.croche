...
const products: Product[] = [
  {
    ...
    description:
      "Receita completa e detalhada da bolsinha de crochê em PDF, desenvolvida para carregar celular e pequenos objetos do dia a dia. O material inclui passo a passo descritivo acompanhado de imagens explicativas, facilitando o entendimento e a execução da peça, mesmo para quem está aprimorando suas habilidades no crochê.",
    image: "https://i.imgur.com/CaEIlya.png",
    downloadUrl: "https://chk.eduzz.com/KW8KD42201",
  },
];
...
export default function RecipesPage({ profile, onBack }: RecipesPageProps) {
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #fafaea 0%, #f5f5e5 50%, #f0f0e0 100%)",
    ...
    >
      <div className="w-full" style={{ maxWidth: "1440px", margin: "0 auto" }}>
        <div className="w-full max-w-4xl mx-auto">
          ...
          <div className="grid gap-6 products-grid">
